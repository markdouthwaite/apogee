...
class Variable(object):
    def __init__(self, name: str, states: list, parameters: list=None, parents: list=None):
        self.name = name
    ...
    def build_factor(self, network):
        ...
        scope = np.asarray([network.id(variable) for variable in variables], dtype=np.int32)
